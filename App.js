...
export default function App() {
 ...
 const getLibros = async() => {
   const respuesta = await axios.get('http://192.168.100.213/API_Libros/')
   setListaLibros(respuesta.data)
}

 const addLibro = async() => {
  const obj = {nombre, edicion}
  const respuesta = await axios.post('http://192.168.100.213/API_Libros/', obj)
...
const deleteLibro = async (props) => {
  const id = props.id
  const respuesta = await axios.delete('http://192.168.100.213/API_Libros/?id='+id)
  alert(respuesta.data.msg)
  getLibros()
}
...
const getLibro = async(props) => {
  const id = props.id
  const respuesta = await axios.get('http://192.168.100.213/API_Libros/?id='+id)
...
const updateLibro = async() => {
  ...
  const respuesta = await axios.put('http://192.168.100.213/API_Libros/',obj)
  alert(respuesta.data.msg)
  setId('') 
  setNombre('')
  setEdicion('')
